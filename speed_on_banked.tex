...
For horizontal circular motion we require $\sum\vec{F}=F_{cp}=m\left(\frac{v^2}{r}\right)$\textit{ horizontally in towards center of velodrome}. Hence, from the diagrams:
\begin{align*}
...
Simplification requires knowledge of sum of sinusoidals with same frequency:
